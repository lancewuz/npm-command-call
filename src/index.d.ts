...
export function adduserBySsoUnsafe(registry?: string, scope?: string, ssoType?: SsoType): Promise<{ token: string, sso: string }>
export function checkSsoToken(token: string, registry: string, scope?: string): Promise<Creds>
